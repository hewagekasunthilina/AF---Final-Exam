    ...
    render() {
        return (
            <div className="align-items-center justify-content-center row" style={{margin: ".5rem", padding: ".5rem"}}>
                <div className={this.state.cardClass} style={{backgroundColor: "#202C55", color: "#fff"}}>
                    <div className="card-body">
                        <h5 className="card-title">UPDATE MY PROFILE</h5>
                        <div>
                        ...
                        <button href="#" className="btn btn-success btn-block"
                                onClick={this.onSaveBtnClick}>Update Profile
                        </button>

                        <button href="#" className="btn btn-danger btn-block"
                                onClick={this.onDeleteButtonClick}>Delete Profile
                        </button>
                    </div>
                </div>
            </div>
